...
| 단계 | 기간 | 주요 작업 |
|---|---|---|
| 기획 | 04.16 ~ 04.17 | 문제 정의, 페르소나 설정, 고객 여정 지도 작성 |
| 모델 구축 | 04.20 ~ 04.23 | STT, 번역, TTS 모듈 구현 및 테스트 |
...
| 팀명 | 이름 | 담당 영역 |
|---|---|---|
| 봄동조 | P** | 프로젝트 기획 및 발표 자료 구성 |
| 봄동조 | M** | 서비스 흐름 정리 및 시연 자료 구성 |
| 봄동조 | P** | 페르소나/고객 여정 및 문제 정의 |
| 봄동조 | J** | STT·번역·TTS 파이프라인 구현 및 GitHub 정리 |
